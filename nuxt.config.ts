...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { name: 'description', content: 'Удаляйте EXIF, XMP, IPTC и PDF-метаданные локально в вашем браузере.' },
        { property: 'og:title', content: 'MetaClean' },
        {
          property: 'og:description',
          content: 'PWA для локальной очистки метаданных изображений, PDF и видео без загрузки на сервер.'
        }
      ]
    }
  },
